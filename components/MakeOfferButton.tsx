  ...
  return (
    <>
      ...
      <button 
        ...
        className="w-full bg-amber-50 text-[#D97706] border-2 border-amber-200 py-3.5 rounded-xl font-bold text-lg hover:bg-amber-100 transition-all flex items-center justify-center gap-2 mt-3"
      >
        <span className="text-xl">🤝</span> Make an Offer
      </button>
