export default function ValuePropBanner() {
  return (
    <div className="relative w-full bg-white dark:bg-[#151515] sm:rounded-t-xl border-x border-t border-slate-200 dark:border-slate-800 py-4 px-4 shadow-sm overflow-hidden z-10">
      
      {/* BACKGROUND EMOJIS (Scattered & Randomly Rotated) */}
      <div className="absolute inset-0 pointer-events-none select-none opacity-[0.03] dark:opacity-[0.06] text-2xl md:text-4xl overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center text-center">
        ...
        {/* Main Headline */}
        <h1 className="text-sm sm:text-base md:text-lg font-black text-slate-900 dark:text-white uppercase tracking-widest leading-tight mb-1">
          Kabale’s Premium Electronics Center
        </h1>

        {/* Sub-headline */}
        <p className="text-[11px] sm:text-xs text-slate-500 dark:text-slate-400 font-medium mb-3 sm:mb-4 max-w-md mx-auto">
          Verified gadgets and accessories at affordable prices.
        </p>

        {/* Feature Pills */}
        <div className="flex flex-wrap items-center justify-center gap-3 sm:gap-4 text-[10px] sm:text-xs font-bold text-slate-700 dark:text-slate-300">
