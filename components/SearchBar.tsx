    ...
    <div className="relative w-full mx-auto" ref={searchRef}>
      <form onSubmit={handleFullSearchSubmit} className="relative flex items-center">
        <input
          ...
          // 🔥 CHANGED: Reduced py-3 to py-2 for a more compact height
          className="w-full pl-4 pr-12 py-2 md:py-2.5 border border-slate-300 rounded-full text-sm focus:outline-none focus:ring-2 focus:ring-[#D97706] focus:border-transparent transition-all shadow-sm"
        />

        <button 
          type="submit"
          aria-label="Submit Search"
          // 🔥 CHANGED: Adjusted width to w-8 md:w-10 to stay circular inside the shorter input
        ...
        >
          {/* 🔥 CHANGED: Scaled icon down slightly to fit the smaller button */}
    ...
    <Suspense 
      fallback={
        <div className="relative w-full mx-auto">
          {/* 🔥 CHANGED: Skeleton loader height reduced to match the new compact search bar */}
