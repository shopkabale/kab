  ...
  return (
    <>
      ...
      <nav className="fixed top-0 w-full bg-white/95 backdrop-blur-md border-b border-slate-200 z-50">
              ...
              {loading ? (
                ...
                <div className="flex items-center gap-4 relative group">
                  ...
                  <div className="relative">
                    <div className="w-10 h-10 rounded-full bg-primary text-white flex items-center justify-center font-bold border-2 border-white shadow-sm cursor-pointer">
                       {user.photoURL ? (
                ...
                <button
                  onClick={signIn}
                  className="rounded-lg bg-white border-2 border-slate-200 px-5 py-2 text-sm font-bold text-slate-700 hover:border-primary hover:text-primary transition-colors"
                >
                  Log In
                </button>
              )}
        ...
        <div className={`lg:hidden absolute w-full bg-white border-t border-slate-200 shadow-xl transition-all duration-300 ease-in-out origin-top ${isMobileMenuOpen ? 'opacity-100 scale-y-100' : 'opacity-0 scale-y-0 pointer-events-none'}`}>
          ...
          <div className="px-4 py-4 space-y-2 border-b border-slate-100">
            ...
            <Link href="/electronics" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-3 rounded-lg text-base font-semibold text-slate-700 hover:text-primary hover:bg-slate-50">
              Electronics
            </Link>
            <Link href="/students" onClick={() => setIsMobileMenuOpen(false)} className="block px-3 py-3 rounded-lg text-base font-semibold text-slate-700 hover:text-primary hover:bg-slate-50">
              Student Market
            </Link>
          </div>
