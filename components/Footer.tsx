...
export default function Footer() {
  ...
  // Helper function to apply the gray/orange active logic for dark mode
  const getLinkStyle = (path: string) => 
    `transition-colors block ${isActive(path) ? 'text-[#D97706] font-bold' : 'text-slate-400 hover:text-[#D97706]'}`;

  return (
    <footer className="bg-[#050505] text-slate-400 border-t border-slate-800 mt-auto text-xs md:text-sm">
      <div className="max-w-7xl mx-auto px-6 py-10 md:py-14">

        {/* ================================================= */}
        {/* MASSIVE CENTERED WHITE LOGO                       */}
        {/* ================================================= */}
        <div className="flex justify-center items-center mb-16 pb-12 border-b border-slate-800/50">
          <Link href="/">
             {/* Replace "/logo-white.png" with your actual white transparent logo path */}
            <img 
              src="/logo-white.png" 
              alt="Kabale Online" 
              className="w-[250px] md:w-[450px] lg:w-[600px] opacity-90 hover:opacity-100 transition-all duration-300 object-contain" 
            />
          </Link>
        </div>
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-8 md:gap-10 mb-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            <h3 className="text-white font-black text-[11px] uppercase tracking-widest mb-4">
              Get in Touch
            </h3>
            <ul className="space-y-4 text-slate-400">
              <li className="flex items-start gap-3">
                <FaLocationDot className="mt-0.5 shrink-0 text-slate-500 text-base" /> 
                <span>Kabale, Uganda</span>
              </li>

              <li className="flex items-center gap-3">
                <FaPhone className="shrink-0 text-slate-500 text-base" /> 
                <a href="tel:+256759997376" className="hover:text-[#D97706] transition-colors">075 999 7376</a>
              </li>

              <li className="flex items-center gap-3">
                <FaEnvelope className="shrink-0 text-slate-500 text-base" /> 
                <a href="mailto:shopkabale@gmail.com" className="hover:text-[#D97706] transition-colors">shopkabale@gmail.com</a>
              </li>

              <li className="flex items-start gap-3">
                <FaClock className="mt-0.5 shrink-0 text-slate-500 text-base" /> 
              ...
              <li className="flex items-start gap-3">
                ...
                <span className="leading-snug text-slate-300">
                  Same day delivery
                  <br/>
                  <span className="text-[11px] text-slate-500 block mt-0.5">If ordered between 6:00 AM - 3:00 PM</span>
                </span>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="/ai" className={`${getLinkStyle('/ai')} flex items-center gap-1.5`}>
                  <svg className={`w-4 h-4 ${isActive('/ai') ? 'text-[#D97706]' : 'text-slate-500'}`} fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M13 10V3L4 14h7v7l9-11h-7z" /></svg>
                  AI Shopping Guide
                </Link>
              </li>
        ...
        {/* ================================================= */}
        <div className="pt-8 border-t border-slate-800 flex flex-col space-y-8">
          <div className="flex flex-col lg:flex-row justify-between items-center space-y-6 lg:space-y-0">
            ...
            <div className="flex flex-col sm:flex-row items-center space-y-4 sm:space-y-0 sm:space-x-6">
              ...
              <Link href="/" className="flex items-center space-x-3 group">
                <div className="w-10 h-10 bg-[#111] rounded-xl overflow-hidden border border-slate-800 flex items-center justify-center shrink-0 p-1">
                ...
                <span className="font-bold text-white group-hover:text-[#D97706] transition-colors">
                  kabaleonline.com
                </span>
              </Link>
              ...
              <a href="https://okaynotice.com" target="_blank" rel="noopener noreferrer" className="flex items-center space-x-3 group">
                ...
                <span className="font-bold text-white group-hover:text-blue-500 transition-colors">
                  okaynotice.com
                </span>
              </a>
            </div>
            ...
            <div className="text-sm font-medium text-slate-500 text-center lg:text-right bg-[#111] px-4 py-2 rounded-lg border border-slate-800">
              <a href="https://okaynotice.com" target="_blank" rel="noopener noreferrer" className="text-blue-500 font-bold hover:text-blue-400 transition-colors">OkayNotice</a> is a proud product of Kabale Online.
            </div>
          </div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-6 pt-6 border-t border-slate-900">
            <p className="text-slate-600 text-[11px] md:text-xs text-center md:text-left font-medium">
            ...
            <div className="flex items-center justify-center gap-6 text-slate-500 text-lg">
              ...
              <a href="https://tiktok.com/@kabale.online" target="_blank" rel="noopener noreferrer" className="hover:text-white transition duration-200" aria-label="TikTok"><FaTiktok /></a>
            </div>
          </div>
        </div>
