...
export default async function AllProductsPage() {
  // Calling getProducts without a category fetches EVERYTHING (latest 20 items)
          ...
          {products.map((product) => (
            ...
            >
              <div className="relative aspect-square bg-slate-100 overflow-hidden">
                ...
                {/* Small Category Badge for the "All Products" view */}
                <div className="absolute top-2 left-2 bg-white/90 backdrop-blur-sm px-2 py-1 rounded text-[10px] font-bold text-slate-700 uppercase tracking-wider shadow-sm">
