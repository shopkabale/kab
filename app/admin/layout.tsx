...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-slate-50 overflow-hidden font-sans">
            ...
            return (
              <Link 
                ...
                className={`flex items-center gap-4 px-4 py-3.5 rounded-2xl font-bold transition-all duration-200 ${
                  isActive 
                    ? "bg-[#D97706] text-white shadow-lg shadow-amber-900/20 translate-x-1" 
      ...
      <aside className={`fixed inset-y-0 left-0 w-72 bg-slate-950 text-white flex flex-col z-50 transform transition-transform duration-300 ease-in-out md:hidden shadow-2xl ${
            ...
            return (
              <Link 
                ...
                className={`flex items-center gap-4 px-4 py-3.5 rounded-xl font-bold transition-all ${
                  isActive ? "bg-[#D97706] text-white shadow-md" : "text-slate-400 hover:bg-slate-800"
                }`}
              >
