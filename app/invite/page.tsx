...
export default function InvitePage() {
  ...
  if (!user) {
    return (
      <div className="max-w-2xl mx-auto p-4 md:p-8 min-h-screen bg-slate-50 pt-10 overflow-x-hidden">
        ...
        <div className="bg-white border border-slate-200 rounded-2xl p-6 md:p-8 shadow-sm mb-8 w-full">
        ...
        <div className="mt-8 flex items-start gap-3 bg-slate-200/50 p-4 rounded-xl text-sm text-slate-600 w-full">
  ...
  // 🚀 PROFESSIONALLY FORMATTED WHATSAPP MESSAGES
  // Using \n for line breaks and *bold* for WhatsApp markdown formatting
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 md:p-8 min-h-screen bg-slate-50 pt-8 overflow-x-hidden">
      ...
      <div className="grid grid-cols-2 gap-4 mb-8">
        <div className="bg-white border border-slate-200 p-5 md:p-6 rounded-2xl shadow-sm w-full">
          <div className="flex items-center gap-2 text-slate-500 mb-2">
            <FaWallet className="text-lg flex-shrink-0" />
            <p className="text-xs font-bold uppercase tracking-wider truncate">Balance</p>
          </div>
          <p className="text-2xl md:text-3xl font-black text-[#D97706] truncate">
            {balance.toLocaleString()} <span className="text-sm md:text-lg text-amber-700">UGX</span>
          </p>
        </div>
        ...
        <div className="bg-white border border-slate-200 p-5 md:p-6 rounded-2xl shadow-sm w-full">
          <div className="flex items-center gap-2 text-slate-500 mb-2">
            ...
            <p className="text-xs font-bold uppercase tracking-wider truncate">Invites</p>
          </div>
          <p className="text-2xl md:text-3xl font-black text-slate-900 truncate">{count}</p>
        </div>
      </div>
      ...
      <div className="bg-white border border-slate-200 p-6 rounded-2xl shadow-sm mb-8 w-full">
        ...
        {/* min-w-0 prevents flexbox from forcing horizontal scroll */}
        <div className="flex flex-col md:flex-row gap-3 min-w-0">
          <div className="flex-1 bg-slate-50 p-3.5 rounded-xl border border-slate-200 overflow-hidden min-w-0">
            <p className="text-sm font-mono text-slate-700 truncate select-all block w-full">{referralLink}</p>
          </div>
          <button 
            onClick={handleCopy}
            className="w-full md:w-auto bg-slate-900 hover:bg-slate-800 text-white px-6 py-3.5 rounded-xl font-bold text-sm shadow-sm transition-colors flex items-center justify-center gap-2 flex-shrink-0"
          >
        ...
        {balance >= 3000 ? (
          <div className="flex flex-col md:flex-row gap-3">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-slate-900 hover:bg-slate-800 text-white font-bold py-3.5 px-4 rounded-xl transition-all shadow-sm flex items-center justify-center gap-2 text-sm text-center"
            >
            ...
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="w-full bg-amber-50 hover:bg-amber-100 border border-amber-200 text-amber-900 font-bold py-3.5 px-4 rounded-xl transition-all flex items-center justify-center gap-2 text-sm text-center"
            >
      ...
      {/* Rules Notice */}
      <div className="bg-slate-100 p-5 rounded-2xl border border-slate-200 text-sm text-slate-600 space-y-2 w-full">
