          ...
          <>
            <section className="w-full pt-6">
              <HorizontalScroller title="Today’s Sponsored Deals" products={boostedProducts} />
                ...
                <section className="relative py-24 md:py-32 overflow-hidden border-y border-slate-200 dark:border-slate-800 my-12 w-full bg-white dark:bg-[#0a0a0a]">
  
  {/* Subtle Ambient Background Glow */}
  <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-[#D97706]/5 dark:bg-[#D97706]/10 blur-[120px] rounded-full pointer-events-none" />

  <div className="relative z-10 w-full max-w-[1000px] mx-auto px-4 sm:px-6 flex flex-col items-center text-center">
    
    {/* Live Status Badge */}
    <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-[#D97706]/10 border border-[#D97706]/20 text-[#D97706] text-xs sm:text-sm font-bold uppercase tracking-widest mb-8">
    ...
    {/* Hero Headline */}
    <h2 className="text-4xl sm:text-5xl md:text-7xl font-black mb-6 text-slate-900 dark:text-white tracking-tight leading-tight">
      Turn your items into <br className="hidden md:block"/>
      <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#D97706] to-amber-500">
        cash instantly.
      </span>
    </h2>

    {/* Value Proposition */}
    <p className="text-base sm:text-lg md:text-xl text-slate-600 dark:text-slate-400 mb-10 leading-relaxed font-medium max-w-2xl mx-auto">
      Reach thousands of buyers across Kabale & Kigezi. Whether you own a shop, are a student, or just clearing out extra items—post directly via our WhatsApp bot.
    </p>
    ...
    <div className="flex flex-col sm:flex-row items-center gap-4 w-full sm:w-auto justify-center mb-12">
      ...
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="group flex items-center justify-center gap-3 px-8 py-4 bg-[#25D366] hover:bg-[#1EBE57] text-white font-bold text-base sm:text-lg rounded-xl transition-all shadow-lg shadow-green-500/20 hover:shadow-green-500/40 hover:-translate-y-0.5 w-full sm:w-auto"
      >
      ...
      <a
        ...
        className="flex items-center justify-center gap-2 px-8 py-4 bg-slate-100 hover:bg-slate-200 dark:bg-slate-800 dark:hover:bg-slate-700 text-slate-900 dark:text-white font-bold text-base sm:text-lg rounded-xl transition-all w-full sm:w-auto"
      >
    ...
    {/* Feature Pillars */}
    <div className="flex flex-wrap justify-center gap-3 sm:gap-6 text-sm font-bold text-slate-700 dark:text-slate-300">
      <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
        <span className="text-lg">⚡</span> Upload instantly
      </div>
      <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
        <span className="text-lg">📍</span> Local community
      </div>
      <div className="flex items-center gap-2 bg-slate-50 dark:bg-slate-900/50 px-4 py-2.5 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm">
        <span className="text-lg">🥇</span> Smart Helper
      </div>
    </div>
