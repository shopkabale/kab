  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-[#111] pb-8 pt-2 sm:pt-4 font-sans selection:bg-[#D97706] selection:text-white overflow-x-hidden">
      ...
      <div className="w-full mt-2">
        ...
        {/* 3. NAVIGATION: Browse more collections (Moved up for immediate user access) */}
        ...
        <div className="w-full space-y-2 mt-2">
          ...
          {/* 6. MOVED: SHOP WITH CONFIDENCE BANNER (Immediately after trending) */}
          <section className="bg-amber-50 dark:bg-[#1a1309] border-y border-amber-200 dark:border-amber-900/50 shadow-sm px-4 py-4 flex flex-col items-center gap-3">
          ...
          {/* 15. MOVED: SELL CTA BANNER (Immediately above Tech Essentials) */}
        ...
        {/* 20. JUMIA-STYLE SEO & ABOUT SECTION (Anchoring the bottom) */}
        <AboutKabaleOnline />
